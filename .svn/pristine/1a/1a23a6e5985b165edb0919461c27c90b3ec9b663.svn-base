...
public class ArgumentParser {
	...
	public boolean isReplay() throws ArgumentParserException {
		return getFlag("replay");
	}

	public boolean isOffer() throws ArgumentParserException {
		return getFlag("offer");
	}

	public boolean isStandard() throws ArgumentParserException {
		return getFlag("standard");
	}
	...
	public String getLog() throws ArgumentParserException {
		return (String) getSetting("log");
	}
	public PlayerType getType() throws ArgumentParserException {
		return parsePlayerType((String) getSetting("type"));
	}
